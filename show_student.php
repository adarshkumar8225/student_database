...
echo('<td><button onclick="location.href = \'edit_student.php?clgid='.$a['clgid'].'\';">Edit</button></td>');
echo('<td><button onclick="location.href = \'delete_student.php?clgid='.$a['clgid'].'\';">Delete</button></td>');	echo('</tr>');
}
